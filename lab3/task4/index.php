...
<body>
    ...
    if (isset($_POST["submit"])) {
        if ($_FILES["fileToUpload"]["error"] === UPLOAD_ERR_OK) {
            $uploadFile = $_FILES["fileToUpload"]["tmp_name"]; // полный путь к временному файлу
            $targetFile = $target_dir . "/" . basename($_FILES["fileToUpload"]["name"]); // полный путь к целевому файлу
